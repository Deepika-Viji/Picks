        ...
        <OverlayScrollbarsComponent
            ...
            <div className="scrollable">
                ...
                <div className="single-message unread">
                    <div className="avatar">
                        <img src="src/assets/images/avatar-3.png" alt="User"/>
                        <span className="active-status active"></span>
                    </div>
                    <div className="part-txt">
                        <div className="top">
                ...
                <div className="single-message">
                    <div className="avatar">
                        <img src="src/assets/images/avatar-4.png" alt="User"/>
                ...
                <div className="single-message unread">
                    <div className="avatar">
                        <img src="src/assets/images/avatar-5.png" alt="User"/>
                        <span className="active-status"></span>
                    </div>
                    <div className="part-txt">
                        <div className="top">
                ...
                <div className="single-message unread">
                    <div className="avatar">
                        <img src="src/assets/images/avatar-6.png" alt="User"/>
                        <span className="active-status"></span>
                    </div>
                    <div className="part-txt">
                        <div className="top">
